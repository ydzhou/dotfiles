" Color setting {
	...
	hi Comment        term=bold  cterm=bold  ctermfg=240
	hi Constant       term=underline  cterm=bold  ctermfg=28
	hi Special        term=bold  cterm=bold  ctermfg=94
	hi Identifier     term=underline  cterm=bold  ctermfg=21
	hi Statement      term=bold  cterm=bold  ctermfg=26
